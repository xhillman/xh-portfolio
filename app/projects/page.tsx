...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div className="project-card-container flex-auto flex flex-col gap-8 items-center justify-center pb-6 md:grid grid-cols-2 auto-rows-[1fr] lg:max-h-[85vh] lg:block sticky top-0 overflow-y-scroll lg:pr-6  lg:[&::-webkit-scrollbar]:w-1
